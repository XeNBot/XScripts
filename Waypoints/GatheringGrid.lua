	...
	},	
	{
		...
		maps = {
			...
			["354"] = {
				...
				nodes = {
					{
						startPos  = Vector3(892.03,140.96,-143.22),
						startPos2 = Vector3(822.91,131.46,15.1),
						...
						nodeName = "Lvl 70 Mineral Deposit",

						nodeItems = {
							{ name = "Fire Crystal", defaultQuantity = 0, id = 8},
							{ name = "Durium Ore", defaultQuantity = 0, id = 19954},
				...
				mapWaypoints = LinkedList(
					{
						...
						Vector3(462.37,55.89,-138.32),
						Vector3(522.43,41.69,-120.1),
						Vector3(719.23,79.39,-196.4),
						Vector3(757.95,101.73,-136.34),
						Vector3(729.9,104.06,-115.51),
						Vector3(720.74,102.41,-122.38),
						Vector3(719.79,102.52,-116.37), --10
						Vector3(712.02,109.43,-107.89),
						Vector3(708.7,110.21,-117.23),
						Vector3(761.2,102.13,-141.03),
						Vector3(782.48,114.06,-115.72),
						Vector3(812.84,120.21,-124.19),
						Vector3(867.03,129.9,-154.87),
						Vector3(883.93,138.53,-161.3),
						Vector3(892.35,140.78,-144.34),
						Vector3(891.64,141.88,-139.45),
						Vector3(893.95,147.04,-128.01),  --20
						Vector3(825.27,125.49,-78.9),
						Vector3(851.47,133.92,-50.26),
						Vector3(809.5,129.76,-15.44),
						Vector3(787.61,126.82,12.44),
						Vector3(813.9,130.57,22.14),
