...
function Ninja:Menu()
	...
	self.class_menu:subMenu("Aeolian Edge", "AEOLIAN_EDGE")
		self.class_menu["AEOLIAN_EDGE"]:setIcon("XScripts", "\\Resources\\Icons\\Actions\\PvP\\Aeolian_Edge.png")
		self.class_menu["AEOLIAN_EDGE"]:checkbox("Use",     "USE", true)

	self.class_menu:subMenu("Fuma Shuriken", "FUMA_SHURIKEN")
		self.class_menu["FUMA_SHURIKEN"]:setIcon("XScripts", "\\Resources\\Icons\\Actions\\PvP\\Fuma_Shuriken.png")
	...
	self.class_menu:subMenu("Mug", "MUG")
		self.class_menu["MUG"]:setIcon("XScripts", "\\Resources\\Icons\\Actions\\PvP\\Mug.png")
	...
	self.class_menu:subMenu("Three Mudra", "THREE_MUDRA")
		self.class_menu["THREE_MUDRA"]:setIcon("XScripts", "\\Resources\\Icons\\Actions\\PvP\\Three_Mudra.png")
		self.class_menu["THREE_MUDRA"]:checkbox("Use",     "USE", true)
		self.class_menu["THREE_MUDRA"]:subMenu("Forked Raiju", "FORKED_RAIJU")
			self.class_menu["THREE_MUDRA"]["FORKED_RAIJU"]:setIcon("XScripts", "\\Resources\\Icons\\Actions\\PvP\\Forked_Raiju.png")
		...
		self.class_menu["THREE_MUDRA"]:subMenu("Hyosho Ranryu", "HYOSHO_RANRYU")
			self.class_menu["THREE_MUDRA"]["HYOSHO_RANRYU"]:setIcon("XScripts", "\\Resources\\Icons\\Actions\\PvP\\Hyosho_Ranryu.png")
		...
		self.class_menu["THREE_MUDRA"]:subMenu("Goka Mekkyaku", "GOKA_MEKKYAKU")
			self.class_menu["THREE_MUDRA"]["GOKA_MEKKYAKU"]:setIcon("XScripts", "\\Resources\\Icons\\Actions\\PvP\\Goka_Mekkyaku.png")
		...
		self.class_menu["THREE_MUDRA"]:subMenu("Meisui", "MEISUI")
			self.class_menu["THREE_MUDRA"]["MEISUI"]:setIcon("XScripts", "\\Resources\\Icons\\Actions\\PvP\\Meisui.png")
		...
		self.class_menu["THREE_MUDRA"]:subMenu("Huton", "HUTON")
			self.class_menu["THREE_MUDRA"]["HUTON"]:setIcon("XScripts", "\\Resources\\Icons\\Actions\\PvP\\Huton.png")
		...
		self.class_menu["THREE_MUDRA"]:subMenu("Doton", "DOTON")
			self.class_menu["THREE_MUDRA"]["DOTON"]:setIcon("XScripts", "\\Resources\\Icons\\Actions\\PvP\\Doton.png")
	...
	self.class_menu:subMenu("Bunshin", "BUNSHIN")
		self.class_menu["BUNSHIN"]:setIcon("XScripts", "\\Resources\\Icons\\Actions\\PvP\\Bunshin.png")
		self.class_menu["BUNSHIN"]:checkbox("Use",     "USE", true)

	self.class_menu:subMenu("Shukuchi", "SHUKUCHI")
		self.class_menu["SHUKUCHI"]:setIcon("XScripts", "\\Resources\\Icons\\Actions\\PvP\\Shukuchi.png")
