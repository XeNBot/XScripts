...
function Machinist:initialize()
	...
	self.actions = {
		...
		heatblast   = Action(1, 7410,  35),
		wildfire    = Action(1, 2878,  45),
		ricochet    = Action(1, 2890,  50),
		heatedsplit = Action(1, 7411,  54),
		drill       = Action(1, 16498, 58),
		heatedslug  = Action(1, 7412,  60),
		heatedclean = Action(1, 7413,  64),
		barrel      = Action(1, 7414,  66),
		airanchor   = Action(1, 16500, 76),
		automaton   = Action(1, 16501, 80),
		chainsaw    = Action(1, 25788, 90),
